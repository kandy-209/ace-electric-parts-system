...
export const metadata: Metadata = {
  title: 'Sales & Services | Ace Electric Motor & Pump',
  description: 'Expert motor repair, pump repair, field service, on-site maintenance, and predictive maintenance services. 24/7 emergency support in Central & Northern California.',
};
